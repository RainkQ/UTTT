...
class MainBoard(object):
    ...
    def add_my_move_inplace(self,  main_board_coords: MainBoardCoords, sub_board_coords: SubBoardCoords):
        self._add_move_inplace(main_board_coords, sub_board_coords, Player.ME)
    def add_opponent_move_inplace(self, main_board_coords: MainBoardCoords, sub_board_coords: SubBoardCoords):
        self._add_move_inplace(main_board_coords, sub_board_coords, Player.OPPONENT)
    ...
    def _add_move_inplace(self, main_board_coords, sub_board_coords, player):
        
        self._board[main_board_coords.row][main_board_coords.col].add_move_inplace(sub_board_coords, player)

        # Check that the next board to play is not finished
        if not self._board[sub_board_coords.row][sub_board_coords.col].is_finished:
            self._sub_board_next_player_must_play = MainBoardCoords(sub_board_coords.row,
        ...
        cell_board = self._as_cell_board()
